...
function exportAsPdf(movies) {
    ...
    htmlContent += `
            ...
            <div class="footer">
                <p>Generated by MovieTrack v2.4.1 | &copy; ${new Date().getFullYear()}</p>
    ...
    const changelogContent = `
        <div style="max-width: 600px; background: var(--card-bg); padding: 30px; border-radius: 12px; max-height: 80vh; overflow-y: auto;">
            ...
            <div style="margin-bottom: 20px;">
                <h3 style="color: var(--text-primary);">Version 2.4.1 - November 2025 🚀</h3>
                <h4 style="color: var(--primary-color); margin-top: 1rem;">Categories Enhancement</h4>
                ...
                <h4 style="color: var(--primary-color); margin-top: 1.5rem;">Previous - Version 2.4.0 - October 2025</h4>
                <ul style="color: var(--text-secondary); line-height: 1.8;">
                    ...
                    <li>💾 30-minute smart caching across both APIs</li>
                    <li>🎯 Optimized for mobile internet and slow connections</li>
                    <li>⏱️ Reduced timeout from 90s to 8s (OMDb is super fast!)</li>
                </ul>
            </div>
