...
function exportAsPdf(movies) {
    ...
    htmlContent += `
            ...
            <div class="footer">
                <p>Generated by MovieTrack v2.5.1 | &copy; ${new Date().getFullYear()}</p>
    ...
    const changelogContent = `
        <div style="max-width: 600px; background: var(--card-bg); padding: 30px; border-radius: 12px; max-height: 80vh; overflow-y: auto;">
            ...
            <div style="margin-bottom: 20px;">
                <h3 style="color: var(--text-primary);">Version 2.5.1 - November 2025 🎉</h3>
                <h4 style="color: var(--primary-color); margin-top: 1rem;">Tags & Lists Feature + Bug Fixes</h4>
                <ul style="text-align: left; margin: 1rem 0; line-height: 1.8;">
                    <li>🏷️ Custom tags system - Add personalized tags to any movie/TV show</li>
                    <li>🎨 Purple gradient tag badges on movie cards</li>
                    <li>📋 Quick tag suggestions (Favorites, Watch Later, Must Rewatch, etc.)</li>
                    <li>✏️ Tag management modal with add/remove functionality</li>
                    <li>🔍 Tags & Lists dedicated page</li>
                    <li>🐛 Fixed displayMovies error (changed to renderMovies)</li>
                    <li>🐛 Fixed tag database integration (customTags field)</li>
                    <li>⚡ Real-time tag updates and display</li>
                </ul>
                
                <h4 style="color: var(--primary-color); margin-top: 1.5rem;">Previous - Version 2.4.1 - November 2025</h4>
                <ul style="color: var(--text-secondary); line-height: 1.8;">
                    <li>✅ Action buttons on category movie cards (Watched/Watching/Watchlist)</li>
                    <li>✅ Load More pagination with smooth scrolling</li>
                    <li>✅ Complete TMDB movie details fetching</li>
                    <li>✅ Enhanced mobile responsive design</li>
                    <li>✅ Movie detail modal optimization</li>
                    <li>✅ Toast notification system</li>
                </ul>
                
                <h4 style="color: var(--primary-color); margin-top: 1.5rem;">Version 2.4.0 - October 2025</h4>
                <ul style="color: var(--text-secondary); line-height: 1.8;">
                    <li>⚡ <strong>Hybrid API System</strong> - OMDb for lightning-fast search + TMDB for trending</li>
                    <li>🌐 <strong>5-10x Faster</strong> search on slow internet (100 KBps+)</li>
                    <li>📡 OMDb API integration for instant autocomplete</li>
                    <li>🎬 TMDB still powers trending, recommendations & genre browsing</li>
                </ul>
            </div>
