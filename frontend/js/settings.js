...
function exportAsPdf(movies) {
    ...
    htmlContent += `
            ...
            <div class="footer">
                <p>Generated by MovieTrack v2.4.0 (Hybrid API) | &copy; ${new Date().getFullYear()}</p>
    ...
    const changelogContent = `
        <div style="max-width: 600px; background: var(--card-bg); padding: 30px; border-radius: 12px; max-height: 80vh; overflow-y: auto;">
            ...
            <div style="margin-bottom: 20px;">
                <h3 style="color: var(--text-primary);">Version 2.4.0 - October 2025 🚀</h3>
